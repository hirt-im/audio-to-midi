...
Upload an audio file and have the notes transcribed and displayed. Control playback by changing its speed, pausing/playing, and going to a specific part of the song by clicking. Save the transcription as a MIDI file to use as you please in other software.
